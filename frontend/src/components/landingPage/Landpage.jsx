...
const LandPage = () => {
    ...
    const components = {
        ...
        section4: {
            buttons: ["Arts & Humanities", "Business", "Computer Science", "Data Science", "Health", "Math & Logic", "Personal Development", "Physical Science & Engineering", "Social Sciences"],
        }
    }
    ...
    return (
        < div className='body'>
            ...
            <div className='main-section'>
                ...
                <p className='sub-heading'>See your personalised recommendations <br/> based on your interests and goals</p>
            ...
            <div className='section-2'>
                <div>
                    <h1>Take your <span>Knowledge</span><br />a degree further</h1>
            ...
            <div className='section-3'>
                <div className='section-3-content'>
                    <h1>Upgrade your <span>skills</span><br /> with <span>FREE</span>online courses<br /></h1>
            ...
            <div className='section-4'>
                <div>
                    <div className='section-4-heading'>
                        <h1>Explore<br /> top <span>subjects</span></h1>
                        <div>
                ...
                <div className='section-4-lower'>
                    <div className='section-4-info'>
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Assumenda libero iusto numquam consequuntur facilis voluptas, sed ipsa, harum inventore eveniet fugiat asperiores ipsam! Veniam aliquid voluptatum eius, praesentium provident perspiciatis!</p>
